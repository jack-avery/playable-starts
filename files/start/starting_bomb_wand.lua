...
gun.mana_charge_speed = { 12, 20 }
gun.mana_max = { 80, 110 }
-- removed MINE (Unstable Crystal) and GRENADE (Firebolt)
gun.actions = { "BOMB", "DYNAMITE", "ROCKET" }
...
ComponentObjectSetValue(ability_comp, "gunaction_config", "fire_rate_wait",
